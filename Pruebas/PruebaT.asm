...
.MODEL SMALL
.STACK 100H
;POSIBLE PROBLEMA A QUE PUEDE PASAR, ES EL TEMA DE BORRAR LA LINEA, PERO ESO SE DEBE CHECAR CUANDO
;GENEREE LAS FIGURAS DE FORMA ALEATORIA
.DATA
    ...
    MORAD    DB 00001101B ; Atributos para el bloque (morado)
...
;DUBUJAR LA BARRA VERTICAL
DIBUJA_BARRA_VERTICAL PROC
    ; Mover el cursor a la posici?n REN y COL
    MOV AH, 2
    MOV DH, REN
    MOV DL, COL ; A?ade esto para ajustar la columna
    MOV BH, 0
    INT 10H
...
BORRA_LINEA PROC ;ESTO ES PARA QUE BORREMOS LA LINEA QUE IRA DEJANDO A COMO SIGA AVANZANDO LA FIGURA
    MOV AH, 2
    MOV DH, REN
    MOV DL, COL
    MOV BH, 0
